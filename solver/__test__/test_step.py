...
class Test(unittest.TestCase):
    ...
    def test_example4(self):
        t = self.t3.get()
        res = PlainTableau(t.table, model_vars=2, base_vars=['_s_1', '_s_2', '_s_3']).collect_result()
    ...
    def test_step(self):
        ...
        res = PlainTableau(t2, model_vars=2, base_vars=['x_1', '_s_1', '_s_2']).collect_result()
    ...
    def test_step_2(self):
        ...
        res = PlainTableau(t3, model_vars=2, base_vars=['x_1', 'x_2', '_s_2']).collect_result()
    ...
    def test_step_3(self):
        ...
        res = PlainTableau(t4, model_vars=2, base_vars=['x_1', 'x_2', '_s_3']).collect_result()
    ...
    def test_step_4(self):
        ...
        res = PlainTableau(t5, model_vars=2, base_vars=['x_1', 'x_2', '_s_3']).collect_result()
        self.assertEqual(VariableValues.from_dict({ 'x1': 2.9999999999999996, 'x2': 12.0}), res)
