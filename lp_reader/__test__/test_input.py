...
class Test(unittest.TestCase):
    ...
    def test_error(self):
        with self.assertRaises(AssertionError):
            self.program = read("__test__/error_program.lp")

    def test_error_var_count(self):
        with self.assertRaises(AssertionError):
            self.program = read("__test__/error_program_2.lp")